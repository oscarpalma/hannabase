...
@section('page_heading','Modificar Empleado')
@section('head')
	...
	<div class="row">
		<div class="panel panel-default">
			...
			<div class="alert alert-danger alert-dismissible" role="alert">
				...
				<strong>¡Alerta!</strong> No se pudo actualizar los datos del empleado.<br><br>
				<ul>
			...
			@endif
			<form class="form-horizontal" role="form" method="POST" action="{{ route('actualizar_empleado',$datosLocalizacion['empleado']->idEmpleado) }}" id="registro-form" data-parsley-validate="" >
				...
				<div class="row">
				    ...
				    <div class="col-sm-4">
						...
						<div >
							<input type="text" class="form-control" name="ap_materno" id="LettersOnly" onkeypress="return inputLimiter(event,'Letters')" @if($datosLocalizacion['empleado'] -> ap_materno == null)
									value="XX" @else  value="{{$datosLocalizacion['empleado'] -> ap_materno}}" @endif  style="text-transform:uppercase" >
						</div>
					</div>
					<div class="col-sm-4">
				...
				<div class="row">
					<div class="col-sm-4">
						...
						<div >
							<input type="text" class="form-control" name="curp" required="" maxlength="18" value="{{$datosLocalizacion['empleado'] -> curp}}" style="text-transform:uppercase" >
