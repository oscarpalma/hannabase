        ...
        saveCB = function(data) {
            ...
            if (pos >= 4 * 320 * 240) {
                ctx.putImageData(img, 0, 0);
                 $('<audio id="sonido_camara"><source src="{{ asset("assets/sonidos/shutter.mp3") }}" type="audio/mpeg"></audio>').appendTo("body");
            ...
            headers: {
                ...
                $.post("/ajax-foto-credencial", {type: "data", image: dataURL, empleado:empleado});
                pos = 0;
            }
        };
