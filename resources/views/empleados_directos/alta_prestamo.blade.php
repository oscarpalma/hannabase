...
@if(isset($success))
	<div class="alert alert-success alert-dismissible" role="alert" id="success">
				...
				<strong><span class="glyphicon glyphicon-ok" aria-hidden="true"></span></strong> Prestamo registrado con exito
				
			</div>
@endif


<form class="form-horizontal" role="form" method="POST" action="{{ route('prestamo_empleados_crtm') }}" id="prestamo-form">
		...
		<div class="panel-body">
			...
			<div class="row">
				...
				<div class="col-sm-3">
					...
					<div >
					<input type="number" name="monto" class="time_element form-control" id="monto" value="" required="" step="0.01" min="0" />
					</div>
