...
<form class="form-horizontal" role="form" method="POST" action="{{ route('post_checada_empleados') }}" id="checada-form">
<input type="hidden" name="_token" value="{{ csrf_token() }}">
    <div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			<!-- Ingresar checadas de todos los días de la semana -->
			<!--<h3>Dias de la semana</h3>
			<div class ="row col-md-offset-2.5">
				<div class="col-sm-1">
					<label class="control-label">Lunes </label>
					<div >
						<input type="checkbox"  class="form-control" name="fecha" value="<?php echo date('Y-m-d'); ?>" id="" max="<?php echo date('Y-m-d'); ?>">
					</div>
				</div>
				<div class="col-sm-1">
...
$("#registrar").click(function(){
      		...
      		if(empleado!="" && cliente!="" && turno!="" && hora_entrada!="" && hora_salida!="" && horas_ordinarias!=""){
		        ...
		        $.ajax({
		            type: "POST",
		            url: "{{ URL::to('empleados/checada/individual') }}",
		            data: dataString,
		            dataType: "json",
		            cache : false,
		            success: function(data){
