...
<form class="form-horizontal @if(isset($parametros['checadas']) && !empty($parametros['empleadosPorChecada'])) collapse @endif" method="POST" action="{{ route('buscar_checadas') }}" id="buscar_checada">
