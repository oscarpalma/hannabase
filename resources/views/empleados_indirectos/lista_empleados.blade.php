            ...
            <div class="row">
                    ...
                    <div class="pull-right" >
                     @if(in_array(Auth::user()->role, ['superusuario', 'administrador']))
                        <button type="button" class="btn btn-success" id="limpiar" title="Limpiar Empleados" data-toggle="modal" data-target="#limpiarModal" >
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper tabla">
                                ...
                                <td ><div class="form-actions">
                                    ...
                                    <a class="btn btn-primary btn-sm btn-circle" href="{{ route('editar_empleado',$empleado->idEmpleado) }}" title="modificar"><i class="fa fa-edit"></i></a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header modal-header-danger">
                                          ...
                                          <div class="modal-body">
                                            <p><strong> ¿Esta seguro de enviar a lista negra al(los) siguiente(s) empleados(s)?</strong></p>
                  ...
                  <table class="table ">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <!-- Modal limpiar empleados -->
<div class="modal fade" id="limpiarModal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
                               
                                <!-- Contenido modal convertir a empleado -->
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header modal-header-success">
                                            <h4 class="modal-title">Limpiar Empleados</h4>
                                          </div>
                                          <div class="modal-body">
                                            <p><strong>Ingrese cantidad de días de tolerancia</strong></p>
                                            <input type="text" id="dias" class="form-control">
                                            <br>
                                            <div class="row">
                                                <div class="col-12-xs text-center">
                                                    <button class="btn btn-success btn-m" id="confirmacionLimpiar">Limpiar</button>
                                                    <button class="btn btn-danger btn-m" data-dismiss="modal">Cancelar</button>
                                                </div>
                                            </div>
                                          </div>
                                    <!-- /.modal-content -->
                                </div> </div>
                                <!-- /.modal-dialog limpiar empleados-->
