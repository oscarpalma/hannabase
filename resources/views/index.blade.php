           ...
           <div class="row">
                        ...
                        <div class="panel-heading" style="background:#337ab7; border-color: #337ab7;">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">{{$nuevos}}</div>
                                    <div>Nuevos registros</div>
                                </div>
                            </div>
                        </div>
                        <a href="{{route('registro_candidato')}}">
                            <div class="panel-footer" style="color:#337ab7;">
                                <span class="pull-left">Nuevo registro</span>
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">{{$candidatos}}</div>
                                    <div>Candidatos</div>
                                </div>
                            </div>
                        </div>
                        <a href="{{route('lista_candidatos')}}">
                            <div class="panel-footer">
                                <span class="pull-left">Lista de candidatos</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-yellow">
                        ...
                        <a href="{{route('lista_empleados_crtm')}}">
                            <div class="panel-footer">
                                <span class="pull-left">Lista de empleados</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">{{$listaNegra}}</div>
                                    <div>Lista Negra</div>
                                </div>
                            </div>
                        </div>
                        <a href="{{route('lista_negra')}}">
                            <div class="panel-footer">
                                <span class="pull-left">Ver lista negra</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
            ...
            <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Empleados registrados - Semana {{date("W")}}
                        </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Grafica de area                            <div class="pull-right">
                                <div class="btn-group">
...
var datos=[{"y":"Lunes","a":{{$datos[0]['a']}}},{"y":"Martes","a":{{$datos[1]['a']}}},{"y":"Miércoles","a":{{$datos[2]['a']}}},{"y":"Jueves","a":{{$datos[3]['a']}}},{"y":"Viernes","a":{{$datos[4]['a']}}},{"y":"Sábado","a":{{$datos[5]['a']}}},{"y":"Domingo","a":{{$datos[6]['a']}}}] 
